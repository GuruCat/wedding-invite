...
$(document).ready(function() {
	...
	var options = {
		center: new kakao.maps.LatLng(37.52219767105263, 127.03899754932249),
		level: 3
	};
	...
	var marker = new kakao.maps.Marker({
		position: new kakao.maps.LatLng(37.52219767105263, 127.03899754932249),
		map: map
	});
	var infowindow = new kakao.maps.InfoWindow({
		content : '<div style="width:150px;text-align:center;padding:5px 0;">더채플 앳 청담</div>' 
	});
	infowindow.open(map, marker);
});